export const API_PATH = {
  ...
  GET_METADATA_PAYMENT: (id: string) =>
    `/api/web3/get-metadata-for-payment/${id}`,
...
export const CONTRACT_ADDRESS = {
  ...
  // USDC_ADDRESS: '0x036CbD53842c5426634e7929541eC2318f3dCF7e', //testnet

  VAULT_ADDRESS: '0xd0f7f1E215B8623675DEccFD8825Da9eB1315569',
  // VAULT_ADDRESS: '0xE2C37bbc09454a0a30eCbE9Aa6406Ca49A35f073', //testnet
};
