    ...
    <div className="rounded-lg overflow-hidden">
      <table className="w-full">
        <thead className="bg-[#1E1F25]">
          <tr>
            <th className="px-6 py-4 text-left text-xs font-medium text-[#777E90]">
              Wallet Address
            </th>
            <th className="px-6 py-4 text-left text-xs font-medium text-[#777E90]">
              Course Title
        ...
        <tbody className="divide-y divide-[#23262F]">
          {paginatedData.map((tx, index) => (
            <tr key={index} className="hover:bg-[#1E1F25] transition-colors">
              ...
              <td className="px-6 py-4">
                <span className="text-sm text-gray-300">{tx.courseTitle}</span>
              </td>
              <td className="px-6 py-4">
                <span className="text-sm text-gray-300">
