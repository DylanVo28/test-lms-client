...
import { TAB_NOTIFICATION, useNotificationTabs, useNotifications } from '@/store/notification/useNotification';
...
const Notification = ({ isOpen }: { isOpen: boolean }) => {
  ...
  const { listByTab, isLoadingTabs } = useNotificationTabs(isOpen, tab);
